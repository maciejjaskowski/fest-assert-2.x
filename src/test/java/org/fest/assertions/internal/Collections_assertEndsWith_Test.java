...
public class Collections_assertEndsWith_Test extends AbstractTest_for_Collections_with_custom_comparison_strategy {
  ...
  public void should_pass_if_actual_ends_with_sequence_according_to_custom_comparison_strategy() {
    collectionsWithCaseInsensitiveComparisonStrategy.assertEndsWith(someInfo(), actual,
  ...
  public void should_fail_if_actual_does_not_end_with_sequence_according_to_custom_comparison_strategy() {
    ...
    Object[] sequence = { "Han", "C-3PO" };
    try {
      collectionsWithCaseInsensitiveComparisonStrategy.assertEndsWith(info, actual, sequence);
    } catch (AssertionError e) {
